...
**File:**  
`Lineer Regression Project 1 (CO2 Emissions) with Regularization Raw_Done.ipynb`
...
- Cross-validation and GridSearch optimization
- ROC-AUC and Precision-Recall evaluation
- Probabilistic prediction and model interpretation

**File:**  
`Logistic Regression Project (Raisin Class Prediction)_Done.ipynb`
